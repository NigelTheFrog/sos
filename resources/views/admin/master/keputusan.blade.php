        ...
        <div class="col-7">
            <div class="card mt-2">
                <div class="card-header">
                    <div class="col">
                        <h3 class="card-title ps-1">Master Keputusan</h3>
                    </div>                    
                    <div class="card-body">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <div class="row justify-content-between pt-2 ps-4 pe-3">
                        <div class="col">
                            <h3 class="card-title">Tambah Keputusan</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="forminput" action="add-user.php" method="POST" class="needs-validation" novalidate>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="usertype" class="form-control" id="usertype" placeholder="Deskripsi Keputusan" required>
