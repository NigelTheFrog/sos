                                ...
                                <tbody>
                                    @foreach ($tertukar as $index => $tertukar)
                                        <tr>
                                            ...
                                            <td>{{ $tertukar->selisihplus }}</td>
                                            <td>{{ $tertukar->selisihmin }}</td>
                                            <td>{{ $tertukar->cogs }}</td>
                                            <td>{{ $tertukar->nominalplus }}</td>
                                            <td>{{ $tertukar->nominalmin }}</td>
                                            <td>
                                ...
                                <tbody>
                                    @foreach ($selisih as $index => $selisih)
                                        <tr>
                                            ...
                                            <td>{{ $selisih->selisihplus }}</td>
                                            <td>{{ $selisih->selisihmin }}</td>
                                            <td>
                                                @if ($selisih->cogs != 0)
