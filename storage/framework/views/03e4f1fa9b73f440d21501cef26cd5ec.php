<?php $__env->startSection('title', 'Dashboard Avalan'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-between align-items-center my-4">
            ...
            <input type="text" id="countCsoActive" value="<?php echo e($countCsoActive); ?>" hidden>
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="col align-items-end">
                            <input class=" form-control col-9 text-center bg-dark-subtle float-end" type="text"
                                placeholder="<?php echo e($csodate); ?>" aria-label="Disabled input example" style="width: 200px"
                                disabled>
                        </div>
                        <div class="col align-items-end">
                            <?php if($countCsoActive > 0): ?>
                                <button type="button" onclick="openModalCSO(this,1)" class="btn btn-warning float-end"
                                    value="1" id="buttonTutupCso" <?php if($countCsoActive > 0): ?> disabled <?php endif; ?>>
                                    <i class="bi bi-stopwatch-fill"></i> Tutup Akses Mobile
                                </button>
                            <?php elseif($countCsoEnd > 0): ?>
        ...
        <div class="row" id="banner-avalan">
            <?php echo $__env->make('admin.dashboard.banner.banner-avalan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <div class="card mt-2">
            <div class="card-header">
                ...
                <div class="card-body" id="main-table-avalan">
                    <?php echo $__env->make('admin.dashboard.table.avalan.main-table-avalan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row justify-content-between mb-2">
                        ...
                        <div class="col-1 me-3">
                            <a href="<?php echo e(url('admin/dashboard/print-avalan/1')); ?>"class="btn btn-primary bi bi-printer-fill">
                                </i>
                                Cetak</button></a>
                        </div>
                    </div>
                    ...
                    <div id="avalanBlmProses">
                        <?php echo $__env->make('admin.dashboard.table.avalan.avalan-belum-proses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row justify-content-between mb-2">
                        <div class="col-1 me-3">
                            <a
                                href="<?php echo e(url('admin/dashboard/print-avalan/3')); ?>"class="btn btn-primary bi bi-printer-fill">
                                </i>
                                Cetak</button></a>
                        </div>
                    </div>
                    <div id="avalanOk">
                        <?php echo $__env->make('admin.dashboard.table.avalan.avalan-ok', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row justify-content-between mb-2">
                        ...
                        <div class="col-1 me-3">
                            <a
                                href="<?php echo e(url('admin/dashboard/print-avalan/4')); ?>"class="btn btn-primary bi bi-printer-fill">
                                </i>
                                Cetak</button></a>
                        </div>
                    </div>
                    <div id="avalanSelisih">
                        <?php echo $__env->make('admin.dashboard.table.avalan.avalan-selisih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade text-left" id="ModalDetailCsoAvalan" tabindex="-1">
        <form id="formSubmitCso" action="<?php echo e(route('avalan.update-cso')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        if($('#countCsoActive').val() == 1) {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/dashboard/check-avalan')); ?>",
                type: 'GET',
        ...
        setInterval(function(event) {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/dashboard/main-table-avalan')); ?>",
                type: 'POST',
        ...
        setInterval(function(event) {
            $.ajax({
                url: "<?php echo e(url('admin/dashboard/banner-avalan')); ?>",
                type: 'GET',                
                success: function(data) {
        ...
        function openModalDetailCSOAvalan(button) {
            ...
            $.ajax({
                url: "<?php echo e(route('avalan.detail-cso')); ?>",
                type: 'POST',
                data: {
                ...
                success: function(data) {
                    ...
                    // $('#formSubmitCso').attr('action', `<?php echo e(route('avalan.update-cso')); ?>`);
        ...
        function openModalCSO(button, type) {
            ...
            if (type == 1) {
                ...
                $('#modalActionCSO').attr('action', `<?php echo e(route('avalan.update', 'item')); ?>`);
            } else if (type == 2) {
                ...
                $('#modalActionCSO').attr('action', `<?php echo e(route('avalan.destroy', 'item')); ?>`);
            } else {
                ...
                $('#modalActionCSO').attr('action', `<?php echo e(route('avalan.store')); ?>`);
            }
        }
        ...
        function openModalBlmProses(button) {
            ...
            intervalAvalanBlmProses = setInterval(function() {
                $.ajax({
                    url: "<?php echo e(url('admin/dashboard/banner-avalan/1')); ?>",
                    type: 'GET',
                    success: function(data) {
        ...
        function openModalOk(button) {
            ...
            intervalAvalanOk = setInterval(function() {
                $.ajax({
                    url: "<?php echo e(url('admin/dashboard/banner-avalan/3')); ?>",
                    type: 'GET',
                    success: function(data) {
                        $('#itemOk').html(data);
                        console.log(data);
        ...
        function openModalSelisih(button) {
            ...
            intervalAvalanSelisih = setInterval(function() {
                $.ajax({
                    url: "<?php echo e(url('admin/dashboard/banner-avalan/4')); ?>",
                    type: 'GET',
                    success: function(data) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/dashboard/avalan.blade.php ENDPATH**/ ?>