<?php $__env->startSection('title','Tipe User'); ?>
    ...
    <div class="row justify-content-md-center">
            ...
            <div class="card mt-2">
                ...
                <div class="card-body" style="background-color:rgb(248, 248, 248)">
                    <table class="table table-sm table-bordered table-hover table-responsive small" style="background-color:rgb(255, 255, 255)">
                        ...
                        <tbody>                                
                            <?php $__currentLoopData = $tipeUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tipeUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td class="align-middle"><?php echo e($index +1); ?></td>
                                <td class="align-middle"><?php echo e($tipeUser->jobtypecode); ?></td>
                                <td class="align-middle"><?php echo e($tipeUser->jobtypename); ?></td>
                                ...
                                <td hidden><?php echo e($tipeUser->jobtypeid); ?></td>
                            </tr>                                    
        ...
        <div class="col-5">
            <div class="card mt-2">
                ...
                <div class="card-body" style="background-color:rgb(248, 248, 248)">
                    <form id="forminput" action="<?php echo e(route("tipe-user.store")); ?>" method="POST" class="needs-validation mx-3" novalidate >
                        <?php echo csrf_field(); ?> 
...
<script>
    function openModalEdit(button) {
        ...
        $('#editform').attr('action',`<?php echo e(url('admin/master/tipe-user/${id}')); ?>`);
    }
    ...
    function openModalDelete(button) {
        ...
        $('#deleteform').attr('action',`<?php echo e(url('admin/master/tipe-user/${id}')); ?>`);    
    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/master/tipe-user.blade.php ENDPATH**/ ?>