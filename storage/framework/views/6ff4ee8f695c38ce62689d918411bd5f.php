<?php $__env->startSection('title', 'Daftar Avalan Selisih'); ?>
        ...
        <section class="content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-secondary">
                    ...
                    <form action="<?php echo e(route('avalan-selisih.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $tertukar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tertukar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(number_format($tertukar->totalcso, 2, ',', '.')); ?></td>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $selisih; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $selisih): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(number_format($selisih->totalcso, 2, ',', '.')); ?></td>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $kesalahan_admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(number_format($admin->totalcso, 2, ',', '.')); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/resume/avalan-selisih.blade.php ENDPATH**/ ?>