<?php $__env->startSection('title', 'Dashboard Item'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row" id="banner-item">
            <?php echo $__env->make('admin.dashboard.banner.banner-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row justify-content-between mb-2">
                            <div class="col-1 me-3">
                                <a
                                    href="<?php echo e(url('admin/dashboard/print-item/1')); ?>"class="btn btn-primary bi bi-printer-fill">
                                    </i>
                                    Cetak</button></a>
                            </div>
                        </div>
                        ...
                        <div id="itemBlmProses" style="overflow: auto; max-height: 75vh;">
                            <?php echo $__env->make('admin.dashboard.table.item.item-belum-proses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row justify-content-between mb-2">
                            <div class="col-1 me-3">
                                <a
                                    href="<?php echo e(url('admin/dashboard/print-item/3')); ?>"class="btn btn-primary bi bi-printer-fill">
                                    </i>
                                    Cetak</button></a>
                            </div>
                        </div>
                        ...
                        <div id="itemOk" style="overflow: auto; max-height: 75vh;">
                            <?php echo $__env->make('admin.dashboard.table.item.item-ok', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <form action="">
                            ...
                            <div class="row justify-content-between mb-2">
                                ...
                                <div class="col-1 me-3">
                                    <a
                                        href="<?php echo e(url('admin/dashboard/print-item/4')); ?>"class="btn btn-primary bi bi-printer-fill">
                                        </i>
                                        Cetak</button></a>
                                </div>
                            </div>
                            <div id="itemSelisih" style="overflow: auto; max-height: 75vh;">
                                <?php echo $__env->make('admin.dashboard.table.item.item-selisih', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="card mt-2">
            ...
            <div class="card-body" id="main-table-item" style="overflow: auto">
                <?php echo $__env->make('admin.dashboard.table.item.main-table-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        if ($('#countCsoActive').val() == 1) {
            setInterval(function(event) {
                $.ajax({
                    url: "<?php echo e(url('admin/dashboard/check-item')); ?>",
                    type: 'GET',
        ...
        function openModalDetailCSO(button) {
            ...
            $.ajax({
                url: "<?php echo e(route('item.detail-cso')); ?>",
                type: 'POST',
                data: {
                ...
                success: function(data) {
                    $('#detailCso').html(data);
                    $('#formSubmitCso').attr('action', `<?php echo e(route('item.update-cso')); ?>`);
        ...
        setInterval(function(event) {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/dashboard/main-table-item')); ?>",
                type: 'POST',
                data: {
                    search: searchValue
                },
        ...
        setInterval(function(event) {
            $.ajax({
                url: "<?php echo e(url('admin/dashboard/banner-item')); ?>",
                type: 'GET',
        ...
        function openModalBlmProses(button) {
            ...
            //     $.ajax({
            //         url: "<?php echo e(url('admin/dashboard/banner-item/1')); ?>",
            //         type: 'GET',
            //         success: function(data) {
        ...
        function openModalOk(button) {
            ...
            //     $.ajax({
            //         url: "<?php echo e(url('admin/dashboard/banner-item/3')); ?>",
            //         type: 'GET',
            //         success: function(data) {
            //             $('#itemOk').html(data);
            //             console.log(data);
        ...
        function openModalSelisih(button) {
            ...
            // intervalItemSelisih = 
            //     $.ajax({
            //         url: "<?php echo e(url('admin/dashboard/banner-item/4')); ?>",
            //         type: 'GET',
            //         success: function(data) {
        ...
        function openModalCSO(button, type) {
            ...
            if (type == 1) {
                ...
                $('#modalActionCSO').attr('action', `<?php echo e(route('item.update', 'item')); ?>`);
            } else if (type == 2) {
                ...
                $('#modalActionCSO').attr('action', `<?php echo e(route('item.destroy', 'item')); ?>`);
            } else {
                ...
                $('#modalActionCSO').attr('action', `<?php echo e(route('item.store')); ?>`);
            }
        }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/dashboard/item.blade.php ENDPATH**/ ?>