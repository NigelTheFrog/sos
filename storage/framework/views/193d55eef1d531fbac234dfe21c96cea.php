<?php $__env->startSection('title','Keputusan'); ?>
    ...
    <div class="row justify-content-md-center">
            ...
            <div class="card mt-2">
                ...
                <div class="card-body" style="background-color:rgb(248, 248, 248)">
                    <table class="table table-sm table-bordered table-hover table-responsive small" style="background-color:rgb(255, 255, 255)">
                        ...
                        <tbody>                                
                            <?php $__currentLoopData = $keputusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td class="align-middle"><?php echo e($index +1); ?></td>
                                <td class="align-middle"><?php echo e($kep->keputusandesc); ?></td>
                                ...
                                <td hidden><?php echo e($kep->keputusanid); ?></td>
                            </tr>                                    
        ...
        <div class="col-5">
            <div class="card mt-2">
                ...
                <div class="card-body" style="background-color:rgb(248, 248, 248)">
                    <form id="forminput" action="<?php echo e(route("keputusan.store")); ?>" method="POST" class="needs-validation mx-3" novalidate >
                        <?php echo csrf_field(); ?>
...
<script>
    function openModalEdit(button) {
        ...
        $('#editform').attr('action',`<?php echo e(url('admin/master/keputusan/${keputusanid}')); ?>`);
    }
    ...
    function openModalDelete(button) {
        ...
        $('#deleteform').attr('action',`<?php echo e(url('admin/master/keputusan/${keputusanid}')); ?>`);    
    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/master/keputusan.blade.php ENDPATH**/ ?>