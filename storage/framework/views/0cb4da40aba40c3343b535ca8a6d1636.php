...
<input type="text" name="itembatchid" id="itembatchid" class="d-none" value="<?php echo e($data->itembatchid); ?>">
<input type="text" name="batchno" class="d-none" value="<?php echo e($data->batchno); ?>">
<input type="text" name="trsdetid" id="trsdetidparam" class="d-none" value="<?php echo e($data->trsdetid); ?>">

<div class="row g-3 mb-3">
    <div class="form-floating col">
        <input class="form-control text-center bg-primary shadow-sm" value="<?php echo e(number_format($data->onhand, 2, ',', '.')); ?>" id="onHand"
            type="text" readonly>
        <label class="fw-bold" for="onHand">On Hand</label>
    </div>
    <div class="form-floating col">
        <input class="form-control text-center bg-warning shadow-sm" value="<?php echo e(number_format($data->totalcso, 2, ',', '.')); ?>" type="text"
            readonly>
        <label class="fw-bold">Qty CSO</label>
    </div>
    <div class="form-floating col">
        <input class="form-control text-center bg-danger shadow-sm" value="<?php echo e(number_format($data->selisih, 2, ',', '.')); ?>" type="text" readonly>
        <label class="fw-bold" for="vselisih">Selisih</label>
    </div>
    <div class="form-floating col">
        <input class="form-control text-center shadow-sm" name="koreksi" value="<?php echo e($data->koreksi); ?>" type="number">
        <label class="fw-bold" for="vkoreksi">Input Koreksi</label>
    </div>
    <div class="form-floating col">
        <input class="form-control text-center shadow-sm" name="deviasi" value="<?php echo e($data->deviasi); ?>" type="number">
...
<div class="row mb-2">
    ...
    <div class="col-2">
        ...
        <button type="button" id="csoulang" onclick="csoUlang(this)" name="csoorder" class="btn btn-info mb-3"
            <?php if($checkCso == 0 || $data->statusdoc == "E"): ?> disabled <?php endif; ?>>CSO Ulang</button>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="checkkesalahanadmin" name="check_kesalahan_admin"
            <?php if(count($analisator) > 0 && $analisator[0]->kesalahan_admin == 1): ?> checked <?php endif; ?>>
...
<div class="">
    ...
    <textarea class="form-control form-control-sm" name="keterangan" id="vketerangan"><?php echo e($data->keterangan); ?></textarea>
</div>
...
<script>
    function hapusAvalanTemuan(button) {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/dashboard/item/hapus-temuan-avalan')); ?>",
            method: "POST",
            data: {
    ...
    function csoUlang(button) {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/dashboard/avalan/cso-ulang')); ?>",
            method: "POST",
            data: {
                itembatchid: itembatchidparam,
            },
...
<?php /**PATH /var/www/html/sos-dev/resources/views/admin/dashboard/table/avalan/detail-cso-avalan.blade.php ENDPATH**/ ?>