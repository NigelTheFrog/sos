            ...
            <tbody>
                <?php if(count($dataAnalisator) > 0): ?>
                    <?php $__currentLoopData = $dataAnalisator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $analisator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="tr-body">
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($index + 1); ?></td>
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($analisator->name); ?></td>
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($analisator->dept); ?></td>
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($analisator->note); ?></td>
                        </tr>
            ...
            <tbody>
                <?php if(count($dataPelaku) > 0): ?>
                    <?php $__currentLoopData = $dataPelaku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pelaku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="tr-body">
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($index + 1); ?></td>
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($pelaku->name); ?></td>
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($pelaku->dept); ?></td>
                            <td class="td-content" style="padding: 8px; font-size: 9pt"><?php echo e($pelaku->note); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <tr class="tr-body">
...
<?php /**PATH /var/www/html/sos-dev/resources/views/admin/report/stok-avalan/pdf-resume-potrait.blade.php ENDPATH**/ ?>