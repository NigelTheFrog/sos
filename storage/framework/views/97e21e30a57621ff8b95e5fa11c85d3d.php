<table class="table table-sm table-bordered table-hover table-responsive small">
    ...
    <tbody>
        <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr
                <?php if($barang->selisih != 0): ?> class="table-danger"
            <?php else: ?>
                class = "table-light" <?php endif; ?>>
                <td hidden>
                    <?php echo e($barang->itemid); ?>
                ...
                <td class="align-middle">
                    <div class="d-flex my-0 align-items-center">
                        ...
                        <div>
                            <?php if($barang->batchno != null): ?>
                                <?php echo e($barang->itemname); ?> - <?php echo e($barang->batchno); ?>
...
<?php /**PATH /var/www/html/sos-dev/resources/views/admin/dashboard/table/item/main-table-item.blade.php ENDPATH**/ ?>