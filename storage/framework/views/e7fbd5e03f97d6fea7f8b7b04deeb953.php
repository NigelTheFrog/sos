<?php $__env->startSection('title', 'Susunan Tim Item'); ?>
    ...
    <div class="content-wrapper">
        <!-- Main content -->
            <div class="container-fluid mt-3">
                ...
                <form action="<?php echo e(route('susunan-tim-cso.update','susunan_tim_cso')); ?>" class="mb-3" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('susunan-tim-cso.update','susunan_tim_cso')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/resume/susunan-tim-cso.blade.php ENDPATH**/ ?>