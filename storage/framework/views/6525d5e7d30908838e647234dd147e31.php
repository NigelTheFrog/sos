                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-4 text-end">
                                        <form method="POST" action="<?php echo e(route('cek-stok-avalan.store')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <input type="text" name="trsidlaporan" value="<?php echo e($trsidlaporan); ?>" hidden>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sos-dev/resources/views/admin/report/preview-avalan/preview-laporan-cso.blade.php ENDPATH**/ ?>